...
class AdminManager {
    ...
    public function addAdmin($telegram_id, $username = null, $added_by_id) {
        ...
        try {
            $isFallback = $this->db->isFallbackEnabled();
            $addedAt = $isFallback ? date('c') : new MongoDB\BSON\UTCDateTime();
            $updatedAt = $isFallback ? date('c') : new MongoDB\BSON\UTCDateTime();
