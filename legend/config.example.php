<?php
// Ex Chk - Configuration File TEMPLATE
...
class DatabaseConfig {
    ...
    const MONGODB_URI = 'mongodb+srv://YOUR_USERNAME:YOUR_PASSWORD@YOUR_CLUSTER.mongodb.net/?appName=YOUR_APP';
...
class TelegramConfig {
    ...
    const NOTIFICATION_CHAT_ID = 'YOUR_NOTIFICATION_CHAT_ID_HERE';
    const BOT_NAME = 'YourBotName'; // Remove @ symbol for widget
    const BOT_SECRET = 'YOUR_BOT_TOKEN_HERE'; // Using bot token as secret for security
}
...
class AppConfig {
    ...
    const CHECKER_API_URL = 'https://your-api-domain.com/autosh.php';
    ...
    const OWNER_IDS = [123456789]; // Replace with your Telegram ID
