...
<body>
    ...
    <script src="assets/js/advanced.js" nonce="<?php echo $nonce; ?>"></script>
    <script src="assets/js/dashboard-enhancements.js" nonce="<?php echo $nonce; ?>"></script>
    <script src="assets/js/security-enhancements.js" nonce="<?php echo $nonce; ?>"></script>
