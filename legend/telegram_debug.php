...
echo "<p><strong>Current Domain:</strong> https://" . htmlspecialchars($_SERVER['HTTP_HOST'] ?? 'unknown', ENT_QUOTES, 'UTF-8') . "</p>";
echo "<p><strong>Auth URL:</strong> https://" . htmlspecialchars($_SERVER['HTTP_HOST'] ?? 'unknown', ENT_QUOTES, 'UTF-8') . htmlspecialchars($_SERVER['REQUEST_URI'] ?? '', ENT_QUOTES, 'UTF-8') . "</p>";
...
echo "<li>Set domain to: <strong>https://" . htmlspecialchars($_SERVER['HTTP_HOST'] ?? 'unknown', ENT_QUOTES, 'UTF-8') . "</strong></li>";
echo "</ol>";
...
echo "data-auth-url='https://" . htmlspecialchars($_SERVER['HTTP_HOST'] ?? 'unknown', ENT_QUOTES, 'UTF-8') . "/web/login.php' ";
