    ...
    <div class="container">
        ...
        <div class="tools-grid">
            <div class="tool-card">
                ...
                <h3 class="tool-title">Enhanced Card Checker</h3>
                <p class="tool-description">
                    Advanced card validator with live credit display, proxy rotation, and modern UI
                </p>
                <div class="tool-cost">
                    <i class="fas fa-coins"></i>
                    <?php echo AppConfig::CARD_CHECK_COST; ?> Credit per check
                </div>
                <a href="enhanced_card_checker.php" class="tool-btn" <?php echo $user['credits'] < AppConfig::CARD_CHECK_COST ? 'style="pointer-events:none;opacity:0.5;"' : ''; ?>>
                    Launch Tool
                </a>
            </div>
            ...
            <div class="tool-card">
                ...
                <p class="tool-description">
                    Manage your proxies, test them, and use them for card checking with automatic rotation
                </p>
                <div class="tool-cost">
            ...
            <div class="tool-card">
                ...
                <h3 class="tool-title">Card Checker (Classic)</h3>
                <p class="tool-description">
                    Classic card validator with traditional interface
                </p>
                <div class="tool-cost">
                    <i class="fas fa-coins"></i>
                    <?php echo AppConfig::CARD_CHECK_COST; ?> Credit per check
